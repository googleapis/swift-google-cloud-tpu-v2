...
public struct GenerateServiceIdentityResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.identity = try container.decodeIfPresent(ServiceIdentity.self, forKey: .identity)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.tpu.v2.GenerateServiceIdentityResponse"
  }
