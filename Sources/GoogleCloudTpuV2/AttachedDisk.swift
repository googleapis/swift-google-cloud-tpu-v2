  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .sourceDisk) {
      self.sourceDisk = value
    }
    if let value = try container.decodeIfPresent(AttachedDisk.DiskMode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.tpu.v2.AttachedDisk"
  }
