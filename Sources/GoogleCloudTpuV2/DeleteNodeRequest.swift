...
public struct DeleteNodeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteNodeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteNodeRequest().with { $0.name = ... }
  /// ```
