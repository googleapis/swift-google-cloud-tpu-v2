  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let runtimeVersions = CodingKeys(stringValue: "runtimeVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([RuntimeVersion].self, forKey: .runtimeVersions) {
      self.runtimeVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.runtimeVersions, forKey: .runtimeVersions)
