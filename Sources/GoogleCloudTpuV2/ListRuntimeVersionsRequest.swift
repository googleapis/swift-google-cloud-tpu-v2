...
public struct ListRuntimeVersionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRuntimeVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuntimeVersionsRequest().with { $0.parent = ... }
  /// ```
