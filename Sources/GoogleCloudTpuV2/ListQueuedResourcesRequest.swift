...
public struct ListQueuedResourcesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListQueuedResourcesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQueuedResourcesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.tpu.v2.ListQueuedResourcesRequest"
  }
