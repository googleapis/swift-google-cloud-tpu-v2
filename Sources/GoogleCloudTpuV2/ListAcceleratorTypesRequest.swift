...
public struct ListAcceleratorTypesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.tpu.v2.ListAcceleratorTypesRequest"
  }
