  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let acceleratorTypes = CodingKeys(stringValue: "acceleratorTypes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AcceleratorType].self, forKey: .acceleratorTypes)
    {
      self.acceleratorTypes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.acceleratorTypes, forKey: .acceleratorTypes)
